    ...
    <div class="flex justify-between  w-[80%] m-auto">
        <div class="w-[30%] border border-slate-300 rounded bg-slate-100 h-[250px]  px-4 py-4 space-y-2">
            <ul class="space-y-2">
                ...
                <li>Nationnalité : <span class="text-slate-800 font-semibold"><?php echo $data['client_nationalite']; ?></span></li>
                ...
                <li>Postal : <span class="text-slate-800 font-semibold"><?php echo $data['client_postal'] ?></span></li>
            </ul>
        </div>
        ...
        <div class="w-[60%] border border-slate-300 rounded bg-slate-100  px-4 py-4 space-y-2 ">
            <ul class="space-y-2">
                ...
                <li class="flex space-x-4">
                    ...
                    <span>Nombre de compte :  <span class="text-slate-800 font-semibold"><?php #echo $Comptes; ?></span></li></span> 
                </li>
                <li class="flex space-x-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                         <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                    </svg>
                    <span>Nombre de bénéficiaire du compte :</span>
                </li>
            </ul>
            ...
            <ul class="flex flex-wrap   justify-around p-2 space-y-4">
                ...
                <li class="p-2 bg-white shadow rounded hover:bg-slate-800 group transition ease-in-out duration-200">
                    <a href="#" class="space-x-4 flex items-center group-hover:text-yellow-200">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
