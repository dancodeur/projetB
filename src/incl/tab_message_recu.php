...
if(isset($_POST['btn'])){
   ...
   if($res){
    ...
    <section class="w-[80%] py-3  m-auto mb-3 bg-green-500 text-slate-50 text-center font-semibold">
        <p>Votre message a été reçu par votre conseiller</p>
    </section>
...
<section class="mb-3">
    ...
    <div class="flex justify-between  w-[80%] m-auto">
        ...
        <div  class="w-[50%] border border-slate-300 rounded bg-slate-100   px-4 py-4 space-y-2" >
            ...
            #include("function/f_message.php");
            $user=$_SESSION['id'];
            $conseiller=1; #Valeur temporaire

            $res=ViewMessageConseiller($conseiller,$user);
                     ...
                     <hr class="mt-2 mb-2">
                      ...
                      <div class=" space-x-3">
                            ...
                            <ul class="flex justify-between items-center">
                                ...
                                <!----delete--->
                                <li>
                                    <a href="delete_message_recu.php?id=<?= $data["message_id"]; ?>">
