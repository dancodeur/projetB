...
<section id="modale" class=" inset-0 absolute flex justify-center items-center z-[2]">
    <div class="bg-white rounded shadow px-4 py-4 w-[30%] m-auto  space-y-4">
         <div class=" flex justify-between ">
             <h1 class=" font-bold">Souhaitez-vous ajouter ce bénéficiaire ?</h1>
         ...
         <div class=" space-y-2 mb-2 ">
             <p>Ce bénéficiaire  sera présent dans la liste de vos bénéficiaires lors de vos virements ! </p>
         </div>
